...
public class ModGlobalLootModifiersProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        add("shattered_glass_from_glass_block", new AddItemModifier(new LootItemCondition[]{
                ...
                MatchTool.toolMatches(ItemPredicate.Builder.item().of(ItemInit.RING_GLASS.get())).build()}, ItemInit.SHATTERED_GLASS_BLOCK.get()));
        add("shattered_glass_from_glass_pane", new AddItemModifier(new LootItemCondition[]{
                ...
                MatchTool.toolMatches(ItemPredicate.Builder.item().of(ItemInit.RING_GLASS.get())).build()}, ItemInit.SHATTERED_GLASS_PANE.get()));
    }
}
